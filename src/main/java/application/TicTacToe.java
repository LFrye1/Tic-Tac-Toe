...
public class TicTacToe {
    ...
    public static final char O_MARKER = 'M'; //changed this from 0 to M bc it was really throwing me off when I ran the
    ...
    public void run() {
        ...
        while (true) {
            ...
            placePiece(board, playerSpot, "player"); //mark the chosen position using the "what", "where" and "who".
            ...
            placePiece(board, cpuSpot, "cpu"); //mark the chosen position using the "what", "where", and "who"
        ...
        public static String checkWinner () {
            ...
            //this part was difficult so let's talk about it so I don't forget what I did
   ...
   // public static char pickYourMarker () {
